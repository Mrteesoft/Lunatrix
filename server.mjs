...
async function copyStaticBuild() {
  ...
  for (const directoryName of ["ai", "checkout", "company", "impact", "login", "plans", "platform", "resources", "signals", "signup", "solutions"]) {
    await cp(join(frontendDir, directoryName), join(staticBuildDir, directoryName), { recursive: true });
  }

  for (const fileName of ["ai.js", "api-base.js", "app.js", "auth.js", "home.js", "runtime-config.js", "signals.js", "styles.css"]) {
